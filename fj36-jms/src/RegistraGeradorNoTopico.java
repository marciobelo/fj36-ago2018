...
public class RegistraGeradorNoTopico 
{
	public static void main(String[] args) throws NamingException 
	{
		...
		{
			ctx.setClientID("GeradorEbook");
			JMSConsumer consumer = ctx.createDurableConsumer(topico, "AssinaturaNotas", "formato='ebook'", false);
			consumer.setMessageListener(new TratadorDeMensagem("GeradorEbook"));
			ctx.start();
